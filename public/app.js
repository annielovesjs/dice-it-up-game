...
function doStuff(val1, val2, val3) {
    ...
    document.querySelector('.text').innerHTML = '<p>In each round, you can roll a dice as many times as you want BUT if you roll a 1, you lose your score and your turn ends. You need to click \'Hold\' to add the value of the die to your total score. The first player to reach a total score of ' + maxScore + ' wins!</p>';
...
document.querySelector('.btn-roll').addEventListener('click', function() {
    ...
    if(gamePlaying) {
        ...
        document.querySelector('.dice').src = './pics/dice-' + dice + '.png';
...
function CustomPrompt(){
	this.render = function(dialog,func){
		...
		document.getElementById('dialogboxhead').innerHTML = "Fill in the info to get started :) ";
